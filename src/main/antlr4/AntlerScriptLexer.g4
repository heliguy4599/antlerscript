...
MAIN_DIRECTIVE: '::' WHITESPACE* 'main' ;
NAMESPACE_DIRECTIVE: '::' WHITESPACE* 'namespace' WHITESPACE+ IDENTIFIER ;
CLASSNAME_DIRECTIVE: '::' WHITESPACE* 'classname' WHITESPACE+ IDENTIFIER ;
OTHER_DIRECTIVE: '::' WHITESPACE* IDENTIFIER ( WHITESPACE+ IDENTIFIER )? ;
