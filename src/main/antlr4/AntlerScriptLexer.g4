...
NAMESPACE_DIRECTIVE: '::' WHITESPACE* 'namespace' ;
CLASSNAME_DIRECTIVE: '::' WHITESPACE* 'classname' ;
...
LGENERIC: '<[' { ignoreSemicolons.push(true); } ;
RGENERIC: ']>' { ignoreSemicolons.pollFirst(); } ;
NULL_ACCESS: '?.' ;
DECORATOR: '@' ;
QMARK: '?' ;
RARROW: '->' ;
