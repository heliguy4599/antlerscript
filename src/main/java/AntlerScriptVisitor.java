...
public class AntlerScriptVisitor extends AntlerScriptParserBaseVisitor<Void> {
	static private final AntlerScriptClassLoader classLoader = new AntlerScriptClassLoader();

	final private ClassWriter cw = new ClassWriter(ClassWriter.COMPUTE_FRAMES | ClassWriter.COMPUTE_MAXS);
