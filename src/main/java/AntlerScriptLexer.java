...
public class AntlerScriptLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"UNICODE_LETTER", "UNICODE_NUMBER", "IDENTIFIER", "NEWLINE", "DIRECTIVE", 
			"ANNOTATION", "DEC_INTEGER", "BIN_INTEGER", "HEX_INTEGER", "EXPONENT_BASE10", 
			"EXPONENT_BASE16", "INTEGER_SUFFIX", "FLOAT_SUFFIX", "INTEGER", "FLOAT", 
			"WHITESPACE", "COMMENT", "RAW_STRING", "STRING", "AND", "ARRAY", "AS", 
			"BREAK", "CAPTURE", "CASE", "CAST", "CLASS", "CONST", "CONSTRUCTOR", 
			"CONTINUE", "DEFER", "ELIF", "ELLIPSIS", "ELSE", "EXTENDS", "FALSE", 
			"FUNC", "IF", "IN", "IS", "ITERATE", "LET", "LIST", "LOOP", "MAP", "MUT", 
			"NOT", "NULL", "OPERATOR", "OR", "PRIVATE_CONSTRUCTOR", "RETURN", "SELECT", 
			"SUPER", "SWITCH", "TRUE", "TYPE", "UNDERSCORE", "WHILE", "YIELD", "SYMBOL", 
			"FROM", "TO", "BY", "SEMICOLON", "LPAREN", "RPAREN", "LBRACK", "RBRACK", 
			...
			"DOUBLE_EQUAL", "NOT_EQUAL", "PLUS_EQ", "MINUS_EQ", "STAR_EQ", "DOUBLE_STAR_EQ", 
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 64:
			return SEMICOLON_sempred((RuleContext)_localctx, predIndex);
		}
		return true;
	}
